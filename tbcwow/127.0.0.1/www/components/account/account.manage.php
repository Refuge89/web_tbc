...
if($user['id']<=0){
    ...
    if(!$_GET['action']){
        ...
        isset($_POST[secreta2]) && strlen($_POST[secreta1])>4 && strlen($_POST[secreta2])>4 && $_POST['secreta1'] != $_POST['secreta2'] && $_POST['secretq1'] != $_POST['secretq2']){
            $DB->query("UPDATE account_extend SET secretq1='$_POST[secretq1]',secretq2='$_POST[secretq2]',secreta1='$_POST[secreta1]',secreta2='$_POST[secreta2]' WHERE account_id='$user[id]'");
        ...
        if ($_POST['reset_secretq']){
          $DB->query("UPDATE account_extend SET secretq1='0',secretq2='0',secreta1='0',secreta2='0' WHERE account_id='$user[id]'");
