...
if(!$_GET['action']){
    ...
    redirect($config['site_href']."index.php?n=admin&sub=forum",1);
    // redirect($config['site_href']."index.php?n=admin&sub=forum&cat_id=".$_GET['cat_id']."&forum_id=".$_GET['forum_id'],1);
