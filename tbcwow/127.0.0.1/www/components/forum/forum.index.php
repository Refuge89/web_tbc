...
foreach($result as $item)
{
    ...
    $item['linktothis'] = $config['site_href'].'index.php?n=forum&sub=viewforum&fid='.$item['forum_id'].'';
    $item['linktolastpost'] = $config['site_href'].'index.php?n=forum&sub=viewtopic&tid='.$item['last_topic_id'].'&to=lastpost';
    $item['linktoprofile'] = $config['site_href'].'index.php?n=account&sub=view&action=find&name='.$item['last_poster'].'';
