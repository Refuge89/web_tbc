...
if($this_forum['forum_id']<=0 || $this_topic['topic_id']<=0)exit('This forum or topic dose not exists.');
// ================================================= //
$this_forum['linktothis'] = $config['site_href'].'index.php?n=forum&sub=viewforum&fid='.$this_forum['forum_id'].'';
$this_forum['linktonewtopic'] = $config['site_href'].'index.php?n=forum&sub=post&action=newtopic&f='.$this_forum['forum_id'].'';

$this_topic['linktothis'] = $config['site_href'].'index.php?n=forum&sub=viewtopic&tid='.$this_topic['topic_id'].'';
$this_topic['linktoreply'] = $config['site_href'].'index.php?n=forum&sub=post&action=newpost&t='.$this_topic['topic_id'];
$this_topic['linktopostreply'] = $config['site_href'].'index.php?n=forum&sub=post&action=donewpost&t='.$this_topic['topic_id'];
$this_topic['linktodelete'] = $config['site_href'].'index.php?n=forum&sub=post&action=dodeletetopic&t='.$this_topic['topic_id'];
$this_topic['linktoclose'] = $config['site_href'].'index.php?n=forum&sub=post&action=closetopic&t='.$this_topic['topic_id'];
$this_topic['linktoopen'] = $config['site_href'].'index.php?n=forum&sub=post&action=opentopic&t='.$this_topic['topic_id'];
$this_topic['linktostick'] = $config['site_href'].'index.php?n=forum&sub=post&action=sticktopic&t='.$this_topic['topic_id'];
$this_topic['linktounstick'] = $config['site_href'].'index.php?n=forum&sub=post&action=unsticktopic&t='.$this_topic['topic_id'];
...
foreach($result as $cur_post)
{
    ...
    // ================================================= //
    $cur_post['linktoprofile'] = $config['site_href'].'index.php?n=account&sub=view&action=find&name='.$cur_post['username'].'';
    $cur_post['linktopms'] = $config['site_href'].'index.php?n=account&sub=pms&action=add&to='.$cur_post['username'];
    $cur_post['linktothis'] = $config['site_href'].'index.php?n=forum&sub=viewtopic&tid='.$this_topic['topic_id'].'&to='.$cur_post['post_id'];
    $cur_post['linktoquote'] = $config['site_href'].'index.php?n=forum&sub=post&action=newpost&t='.$this_topic['topic_id'].'&quote='.$cur_post['post_id'];
    $cur_post['linktoedit'] = $config['site_href'].'index.php?n=forum&sub=post&action=editpost&post='.$cur_post['post_id'];
    $cur_post['linktodelete'] = $config['site_href'].'index.php?n=forum&sub=post&action=dodeletepost&post='.$cur_post['post_id'];
    // ================================================= //
  $pnc++;
