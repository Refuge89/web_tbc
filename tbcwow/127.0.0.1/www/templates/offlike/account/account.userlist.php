...
ACCESS DENIED! Login to view this information.  
 <?php }else{ ?>
<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%" class="bordercolor" style="font-size:0.8em;">
  <tbody>
    ...
    <tr style="text-align: center;">
      <td class="windowbg2">
        <a href="index.php?n=account&sub=pms&action=add&to=<?php echo $item['username']; ?>" title="<?php echo $lang['personal_message'];?>"><img src="templates/offlike/images/icons/email.gif" alt="<?php echo $lang['pers_mess'];?>" align="middle"></a>
      </td>
      ...
      <td class="windowbg2"><?php if($item['hideemail']!=1){ ?><a href="mailto:<?php echo $item['email']; ?>"><img src="./templates/offlike/images/icons/email_open.gif" alt="[Email]" title="Email" border="0" /></a><?php } ?></td>
      <td class="windowbg"><?php if($item['homepage'] && $item['homepage']!='http://'){ ?><a href="<?php echo $item['homepage']; ?>" target="_blank"><img src="templates/offlike/images/icons2/www.gif" alt="WWW" border="0" /></a><?php } ?></td>
