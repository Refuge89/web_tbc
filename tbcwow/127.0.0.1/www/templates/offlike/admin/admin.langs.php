 ...
 <u>Choose language to edit :</u>
  <ul>
    <?php foreach($languages as $lang_s=>$lang_name){ 
        ...
        if($lang_s!=$config['default_lang']) echo ' &nbsp;<a title="'.$lang['dodelete'].'" href="index.php?n=admin&sub=langs&action=delete&lang='.$lang_s.'" onclick="return confirm(\'Are you sure?\');"><img src="'.$config['template_href'].'images/icons/bin_closed.gif" align="absmiddle"></a>';
        echo "</li>";
    } ?>
  </ul>
...
<p>
 ...
 <td><a href="#" onclick="removerow(<?php echo $vic;?>);return false;"><img src="<?php echo $config['template_href'];?>images/icons/bin_closed.gif" align="absmiddle"></a></td>
 </tr>
 <?php } ?>
 </table>
 ...
 function add_pair(){
     ...
     text += '<td><a href="#" onclick="removerow('+vic+');return false;"><img src="<?php echo $config['template_href'];?>images/icons/bin_closed.gif" align="absmiddle"></a></td></tr>';
