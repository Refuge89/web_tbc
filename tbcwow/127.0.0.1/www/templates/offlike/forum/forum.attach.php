...
@import "<?php echo $config['template_href'];?>css/main.css";
@import "<?php echo $config['template_href'];?>css/adding.css";
</style>
	...
	<tbody>
        <tr>
            ...
            <div style="border: 2px dotted #cdcdcd;background:none;margin:4px;padding:6px 9px 6px 9px;text-align:right;width:93%;">
                <img onClick="window.close();" src="<?php echo $config['template_href']; ?>images/cancel_f2.png" style="float:left;cursor:pointer;" alt="<?php Lang('close');?>" title="Закрыть" align="absmiddle">
                <?php Lang('max_file_size');?>: <?php echo $this['maxfilesize'];?> <br />
                <?php Lang('allowed_ext');?>: <?php echo $config['allowed_attachs'];?> <br />
		...
		<tr style="text-align: center;">
			...
			<td class="windowbg2" align="left"><a href="javascript:selectattach('<?php echo $attach['attach_id']; ?>');" title="вставить в сообщение"><?php echo $attach['attach_file']; ?></a></td>
			...
			<td class="windowbg" align="center"><a href="index.php?n=forum&sub=attach&action=delete&attid=<?php echo $attach['attach_id']; ?>&tid=<?php echo$_GET['tid'];?>" title="<?php Lang('delete');?>">
      <img src="<?php echo $config['template_href']; ?>images/trash.png" alt="[del]" align="absmiddle"></a></td>
		</tr>
		<?php } ?>
        <tr class="tablebottom">
			<td colspan="8">Files summary: <?php echo $all_attachs_count; ?> | Size summary: <?php echo $this['goodsize']; ?> </td>
		</tr>
	</tbody>
</table>
<?php } ?>
