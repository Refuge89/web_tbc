...
<td class="tableoutline">
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" height="22" style="background-image:url(<?php echo $config['template_href'];?>images/forumliner-bg2.gif)"><tr><td></td></tr></table>
...
<form class="clearfix" method="post" action="index.php?n=forum&sub=post&action=do<?php echo $_GET['action'];?>&f=<?php echo $_GETVARS['f'];?>&t=<?php echo $_GETVARS['t'];?>&post=<?php echo $_GETVARS['post'];?>" enctype="multipart/form-data">
        ...
        <input name="subject" type="text" id="title" size="35" maxlength="80" value="<?php echo $content['subject'];?>" />
      </p>
	  <br />
    <?php } ?>
...
</div></div><table cellspacing="0" cellpadding="0" border="0" width="100%" height="22" style="background-image:url(<?php echo $config['template_href'];?>images/forumliner-bg2.gif)"><tr><td></td></tr></table>
