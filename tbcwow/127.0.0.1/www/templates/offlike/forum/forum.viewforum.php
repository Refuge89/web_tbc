...
if( $_REQUEST['fid'] == $site_spesific_config[forum][bugs_forum_id] && $site_spesific_config[forum][externalbugstracker] == 1)
{
    if ($site_spesific_config[forum][frame_bugstracker] == 1)
    {
        echo "<center>";
        echo "</br>";
		echo "<iframe src=\"".$site_spesific_config[forum][bugstracker_external_link]."\" style=\"height:1050;\" width=\"680\" frameborder=\"0\" scrolling=\"yes\">Your browser does not support inlineframes.</iframe>";
    }
    else
        echo'<meta http-equiv=refresh content="0;url=\''.$site_spesific_config[forum][bugstracker_external_link].'\'">';
}
else
{
?>
...
<td class="tableoutline">
    ...
    <td>
        ...
        <div class="right"><table width="99%" border="0" cellpadding="0" cellspacing="0" class="tableoutline" style="margin: 1 auto;">
            <tr>
...
<small><div align="center">Legend :</div></small>
  ...
  <table class="tb2" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>	<tr>
	  <td><img src="<?php echo $config['template_href'];?>images/square-new.gif" style="margin: 0pt 3px 0pt 2px;" alt="New Post" border="0"><small>&nbsp;<?php echo $lang['newsubject'] ?>&nbsp;</small></td>
      <td><img src="<?php echo $config['template_href'];?>images/square.gif" style="margin: 0pt 3px 0pt 2px;" alt="Unviewed Post" border="0"><small>&nbsp;<?php echo $lang['readsubject'] ?>&nbsp;</small></td>
      <td><img src="<?php echo $config['template_href'];?>images/square-grey.gif" alt="Viewed Post" border="0"><small>&nbsp;<?php echo $lang['notreadsubject'] ?>&nbsp;</small></td>
      </tr>
  </tbody></table>
