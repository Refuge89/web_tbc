...
<img src="<?php echo $config['template_href'];?>images/forum_head.jpg" border="0" width="100%" />
<script language="javascript">
    function select_and_go(url){
        if(url != 0){
            conf = popup_ask('Are u sure ?');
...
<div id="search">   
    <ul>
        ...
        <?php } ?>
        <li><img src="<?php echo $config['template_href'];?>images/forum-menu-search-right.gif" alt="" width="83" height="39" border="0" /></li>
    </ul>
    <div class="forum-index" id="forum-index">
    <a href="<?php echo $this_forum['linktothis']; ?>">
        <img src="<?php echo $config['template_href'];?>images/forum-index.gif" width="104" height="41" border="0" alt="Forum Index" title="Forum Index" />
    </a>
    </div>
</div>
...
<td class="tableoutline">
    ...
    <td>
        ...
        <div id="topicview" style="font-weight: normal;">
            <ul>
                <li><span title="General Thread"><img src="<?php echo $config['template_href'];?>images/index-icon.gif" width="14" height="15" border="0" alt="General Thread" /></span></li>
                <li><span title="<?php echo $this_topic['topic_name']; ?>" class="white"><b>&nbsp;Topic&nbsp;<a href="<?php echo $this_topic['linktothis']; ?>" class="active"><?php echo $this_topic['topic_name']; ?></a></b></span></li>
                        ...
                        <div class="postingcontainer<?php echo $post['bg']; ?>1">
                            <div class="insert">
                                <table id="posttable<?php echo $post['bg']; ?>1" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td class="id<?php echo $post['bg']; ?>1" rowspan="2">
                                        <!-- Begin Avatar Panel -->
                                        <div>
                                            <div id="avatar<?php echo $post['bg']; ?>1">
                                                <div class="shell">
                                                    ...
                                                    <div class="frame">
                                                        <img src="<?php echo $config['template_href'];?>images/pixel.gif" width="82" height="83" border="0" alt="" />
                                                    </div>
                                                </div><!-- end shell -->
                                                <div style="position: relative;">
                                                    <div class="iconPosition">
                                                        <!--<img src="<?php echo $config['template_href'];?>images/blizz.gif"/>-->
                                                        <b><small><?php echo $post['g_prefix']; ?></small></b>
                                                    </div>
                                        <!-- //Begin Character Control Panel// -->

                                        <div style="position: relative; width: 200px;">
                                            <div class="userpanel">
<a href="index.php?n=account&sub=view&action=find&name=<?php echo $post['username']; ?>"><img class="icon-search" src="<?php echo $config['template_href'];?>images/search.gif"
onmouseover="ddrivetip('View <?php echo "$post[username]\'s"; ?> profile','#ffffff')"; onmouseout="hideddrivetip()" alt="View <?php echo "$post[username]\'s"; ?> profile" /></a>
<a href="<?php echo $post['linktopms']; ?>"><img class="icon-ignore" src="<?php echo $config['template_href']; ?>images/editor/mail.gif" onmouseover="ddrivetip('Send a PM to <?php echo "$post[username]"; ?> ','#ffffff')"; onmouseout="hideddrivetip()" alt="ignore" /></a>
<!--<a href="#"><img class="icon-ignore" src="<?php echo $config['template_href'];?>images/ignore-user.gif" onmouseover="ddrivetip('Toggle Ignore / Unignore This User','#ffffff')"; onmouseout="hideddrivetip()" alt="ignore" /></a> -->
                                            </div>
                                        </div>
                                        ...
                                        <div style="position: relative; width: 200px;">
                                            <div class="userpanel">   
                                                <a href="/search.html?forumId=10001&amp;characterId=677607770&amp;sid=1"><img class="icon-search" src="<?php echo $config['template_href'];?>images/search.gif" onmouseover="ddrivetip('View All Posts by This User','#ffffff')"; onmouseout="hideddrivetip()" alt="view posts by this user" /></a>
                                                <a href="#"><img class="icon-ignore" src="<?php echo $config['template_href'];?>images/ignore-user.gif" onmouseover="ddrivetip('Toggle Ignore / Unignore This User','#ffffff')"; onmouseout="hideddrivetip()" alt="ignore" /></a>
                                            </div>
                                        </div>
                                        -->
                                        ...
                                        <div style="position: relative; width: 200px;">
                                            <div class="pinfo">
                                                <div class="pinfobackground">
                                                    <span><b style="color:#ffac04;"><?php echo $post['username']; ?></b></span>
                                                    <div>
                                                    <?php
                                                    // Get posts
                                                    ...
                                                    ?>
                                                        <ul class="listinfo" style="clear: both;">
                                                            <li class="icon-realm"><small><b><?php echo $post['g_title']; ?></b></small></li>
                                                            <li><small>Posts: <?php echo $posts; ?></small></li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <td class="tools<?php echo $post['bg']; ?>1">
                                        <!-- Begin Post Info -->
                                        ...
                                        <div class="miniadmin" id="post<?php echo $post['post_id']; ?>">
                                            ...
                                            <!-- Post Admin --> 
                                                ...
                                                <li><a href="<?php echo $post['linktoedit']; ?>" onClick="return popup_ask('<?php echo $lang['edit'];?> ?');"><img src="<?php echo $config['template_href'];?>images/edit-button.gif" border="0" alt="[edit]" align="top" /></a></li>
                                                <?php } if(($user['id']==$post['poster_id'] && $user['g_delete_own_posts']) || $user['g_forum_moderate']==1){ ?>
                                                <li><a href="<?php echo $post['linktodelete']; ?>" onClick="return popup_ask('<?php echo $lang['delete'];?> ?');"><img src="<?php echo $config['template_href'];?>images/delete-icon.gif" border="0" alt="[delete]" align="top" /></a></li>
                                                <?php } ?>
                                                <?php if($user['g_reply_other_topics']==1 && $this_topic['closed']!=1){ ?>
                                                <a href="<?php echo $post['linktoquote']; ?>" class="quote"><img src="<?php echo $config['template_href'];?>images/quote-button.gif" width="63" height="18" border="0" title="<?php echo $lang['quote'];?>" alt="[quote]" /></a>
                                                <a href="<?php echo $this_topic['linktoreply']; ?>#write_form" class="scroller"><img src="<?php echo $config['template_href'];?>images/reply-button.gif" width="63" height="18" border="0" title="<?php echo $lang['reply'];?>" alt="[reply]" /></a>
                                                <?php } ?>
                                            </ul>   
                                        </div>
                                        <!-- End Post control Panel -->
                                        <!-- //grabs moderator tools -->
                                        </td>
                                    </tr>
                                    <tr>
...
<?php
switch($post['gmlevel']){
    case 0:  $post_col = "#FFFFFF"; break;
    case 1:  $post_col = "#66FFFF"; break;
    case 2:  $post_col = "#66FFFF"; break;
    case 3:  $post_col = "#66FFFF"; break;
    default: $post_col = "#66FFFF"; break;
}

echo "<font color='$post_col'> ".$post['message']."</font>";
?>
<?php if($post['edited']){ ?><p><small><font color="red">[</font><font color="white"> Post edited by <?php echo $post['edited_by'].' &nbsp;'; echo date('d-m-Y H:i:s',$post['edited']);?> </font><font color="red">]<br /></font></small></p><?php } ?>
																														<?php
...
<div class="forum-index">
  <div class="findex">
    <a href="<?php echo $this_forum['linktothis']; ?>"><img src="<?php echo $config['template_href'];?>images/forum-index.gif" width="104" height="41" border="0" title="" alt="" /></a>
  </div>
</div>
...
<div style="position: relative; width: 100%;">
    <div style="position: absolute; left: 20px; top: -78px;_top: -85px;">
        ...
        <a href="<?php echo $this_forum['linktothis']; ?>" class="index"><img src="<?php echo $config['template_href'];?>images/jump-button.gif" alt="Jump To This Forum" width="21" height="19" border="0" style="margin-bottom: 3px;" align="top" title="Jump To This Forum"/></a>
    </div>
</div>
<br clear="all" />
